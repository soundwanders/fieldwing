<script lang="ts">
	...
	export let message: string =
		'We encountered an unexpected error. Please try again or report this issue if it persists.';
	...
	<div class="error-boundary" class:light={!$theme} class:dark={$theme}>
		<div class="error-content">
			...
			<div class="error-actions">
				<button class="retry-button" on:click={retry} type="button"> 🔄 Try Again </button>
